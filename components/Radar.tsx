...
export default function Radar({
  ...
  useEffect(() => {
    ...
    function update(time: number) {
      ...
      program.uniforms.uTime.value += dt * 0.001;
      ...
      if (!isHovered && Math.abs(targetMouse[0] - currentMouse[0]) < 0.01 && Math.abs(targetMouse[1] - currentMouse[1]) < 0.01) {
