...
`;
    ...
    class Simulation {
      ...
      update() {
        ...
        this.externalForce.update({
          cursor_size: this.options.cursor_size, mouse_force: this.options.mouse_force,
        ...
        const pres = this.poisson.update({ iterations: this.options.iterations_poisson });
    ...
    return () => {
      ...
      if (resizeObserverRef.current) { try { resizeObserverRef.current.disconnect(); } catch (_) { void 0; } }
      if (intersectionObserverRef.current) { try { intersectionObserverRef.current.disconnect(); } catch (_) { void 0; } }
